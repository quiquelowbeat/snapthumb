    ...
    static Stream<Object[]> nullParametersProvider() {
        return Stream.of(
                ...
                new Object[] { UUID.randomUUID().toString(), null, "Title test", "Description test",
                        LocalDateTime.now() },
                new Object[] { UUID.randomUUID().toString(), "http://www.test.com", null, "Description test",
                        LocalDateTime.now() },
                new Object[] { UUID.randomUUID().toString(), "http://www.test.com", "Title test", null,
                        LocalDateTime.now() },
                new Object[] { UUID.randomUUID().toString(), "http://www.test.com", "Title test", "Description test",
                        null });
    }
